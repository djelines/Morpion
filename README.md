...
**Remarque** : Il n'y a pas d'interface graphique, le jeu se joue uniquement via la console.
...
**Note**: There is no graphical interface, the game is played purely via the console.
...
- Automatic winner or draw check.
